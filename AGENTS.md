...
2. `Data/Parts/Inventory.json` is **gitignored**; it represents personal/local stock state. `Data/Parts/PriceCache.json` is committed shared price data (regenerated by BOMManager / `hwrelease update`).

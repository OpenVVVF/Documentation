...
### Software overcurrent → latched Critical fault
...
### Correct interrupt save/restore
...
### Telemetry overflow / drop detection
...
### Fix the duplicated `TIM1->BDTR` restore in `ResistanceCalibrator`
...
### Validate saved/restored hardware state
...
### Add timeouts to busy-wait calibration loops
...
### Re-enable encoder timeout fault
...
### Abstract the phase-pair mapping

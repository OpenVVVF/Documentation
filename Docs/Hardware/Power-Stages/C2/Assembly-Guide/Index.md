...
1. Preparation
2. IGBT mounting
3. IGBT temperature-sensor wiring harnesses
4. IGBT temperature-sensor mounting
5. DC-link capacitor board (PCB population)
6. DC-link filter board (PCB population)
7. Bottom stack assembly — spacers, bus bars, and filter board mounting
8. DC-link module assembly and insertion
9. Chassis boards

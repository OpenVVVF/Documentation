...
<ul>
<li><strong>Just want to spin a motor?</strong> - the FOC demo firmware can be flashed straight from RTE Studio, and the guided motor-calibration routine takes it from there - no firmware build or toolchain setup needed. You can go from unboxing to a spinning motor in just a few minutes. *(RTE Studio documentation is coming soon.)*</li>
...
<li><strong>Developers</strong> - see the <a href="Hardware/Control-Assembly/Index.md">Control Assembly</a> docs. Firmware and host-software documentation is being rewritten and will be published later.</li>

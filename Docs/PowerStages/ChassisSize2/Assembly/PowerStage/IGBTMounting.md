...
doc_id: OV-ASSY-C2-IGBT
title: Chassis Size 2 — IGBT Module Mounting
...
Continue with the remaining Chassis Size 2 assembly steps in the user manual (`OV-UM-C2`) before applying power.

...
status: draft
placeholder: true
description: Base firmware image, RTE host setup, flashing procedures, and custom software development for the control module.
nav_order: 120
normative_refs:
  - OV-SW-MAINMCU-INDEX
  - OV-SW-MAINMCU-ARCH
...
3. RTE host setup and configuration

---
doctype: User Manual
doc_id: OV-C2-UM-INDEX
title: OpenVVVF Chassis Size 2 — User Manual
...
status: draft
placeholder: true
description: Installation, integration, and operating manual for the Chassis Size 2 power-stage family. Under revision.
nav_order: 321
normative_refs:
  - OV-SAF-HARA-CORE
...
# OpenVVVF Chassis Size 2 — User Manual

> **NOTE**
> This manual is under revision. The previous version contained a large amount of control-module content that is shared across all chassis sizes and belongs in the `OV-CA-UHW-INDEX` Control Assembly User Hardware Manual. It also presented specific capacitor and current ratings that do not apply to all C2 variants.
>

...
| CLM-2 | DC-link spreader plate rises approximately +35.0 K over the heatsink base at 40 W capacitor heat load (with thermal paste, rev-B 6.35 mm plate, 63 mm rods); ~75 C plate at 40 C heatsink base | OV-C2-DD-DCLINK-THERMAL | T-05 |
...
| CLM-2 | Plate rise 28-42 K at 40 W (35.0 K ±20 %, rev-B 6.35 mm plate, 63 mm rods). Design-doc value is an unvalidated 1-D estimate; this test is its validation. | T-05 |
